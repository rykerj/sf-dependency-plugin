...
const index_2 = require("../../lib/retriever/index");
class DependencyResolve extends core_1.Command {
    async run() {
        ...
        const { missingComponents } = await (0, index_2.retrieveAndDiff)(config.org, packageXmlPath, retrieveDir);
        ...
        if (missingComponents.length > 0) {
            ...
            const pruned = (0, index_2.pruneGraphFromMissing)(graph, missingComponents);
            if (pruned.length > 0) {
