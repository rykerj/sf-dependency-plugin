...
function analyzeApexFile(filePath) {
    ...
    try {
        ...
        const input = antlr4_1.CharStreams.fromString(source);
        const lexer = new apex_parser_1.ApexLexer(input);
...
function buildVisitor() {
    class DependencyVisitor extends apex_parser_1.ApexParserBaseVisitor {
        constructor() {
            super(...arguments);
            this.deps = [];
